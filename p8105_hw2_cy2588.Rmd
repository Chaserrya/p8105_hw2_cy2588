...
* The resulting dataset is in `r nrow(result_df)` x `r ncol(result_df)` dimension, and the years range of data is `r range(pull(result_df, year))`. The resulting dataset contains 11 variables, which are: `r ls(result_df)`.  
