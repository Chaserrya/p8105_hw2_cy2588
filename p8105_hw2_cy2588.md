...
variables related to the umemployment rate at any given time. \* The
resulting dataset is in 1391 x 11 dimension, and the years range of data
is 1947, 2015. The resulting dataset contains 11 variables, which are:
close, gov\_dem, gov\_gop, month, president, rep\_dem, rep\_gop,
sen\_dem, sen\_gop, unempolyment\_%, year.
